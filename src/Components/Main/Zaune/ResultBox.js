    ...
    return(
        ...
        <div className="auswahlBox">
            <div className="productProperties">
                ...
                <p className="properties">Zaunspitze:</p>
            ...
            <div className="productValues">
                ...
                <p className="properties">{props.zaunspitze}</p>
        ...
        <p className="aktuellerPreis"><b>Preis:</b> {props.preis.toFixed(2)} EUR <span className="mwst">zzgl. MwSt. und inkl. Montage</span></p>

        <div className="resultButtonWrapper">
                 <button onClick={props.createAngebot} className="buttonResult">Angebot herunderladen</button>
